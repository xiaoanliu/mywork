...
(function (e) {
    ...
    var b = {
        init: function (g) {
            ...
            return this.each(function () {
                ...
                if (typeof C == "undefined") {
                    var E = "3";
                    if (
                        g.hasOwnProperty("bootstrap_version") &&
                ...
                if (C.bootstrap_version == "3") {
                    ...
                    w += "</div>";
                    if (
                        (C.showGoToPage && C.visiblePageLinks < C.totalPages) ||
                        C.showRowsPerPage
                    ) {
                        ...
                        if (I.which === 13) {
                            ...
                            if (
                                !(
                                    I.which === 8 ||
                                    I.which === 0 ||
                                    (I.shiftKey === false && I.which > 47 && I.which < 58)
                                )
                            ) {
                                I.preventDefault();
                            }
                        ...
                        if (H.which === 13) {
                            ...
                            if (
                                !(
                                    H.which === 8 ||
                                    H.which === 0 ||
                                    (H.shiftKey === false && H.which > 47 && H.which < 58)
                                )
                            ) {
                                H.preventDefault();
                            }
        ...
        setRowsInfo: function (g) {
            var h = this,
                i = c(
                    b.getOption.call(h, "getOption", "nav_rows_info_id_prefix"),
                    h.attr("id")
                );
            e("#" + i).html(g);
        }
    ...
    var f = function (F, k, g, J, u) {
        ...
        var D =
            rsc_bs_pag.current_page_label +
            " " +
            g +
            " " +
            rsc_bs_pag.total_pages_label +
            " " +
            B.totalPages;
        p.prop("title", "");
        K.prop("title", D);
    ...
    e.fn.bs_pagination = function (h) {
        if (this.size() != 1) {
            var g =
                "You must use this plugin (" + d + ") with a unique element (at once)";
